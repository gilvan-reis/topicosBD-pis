...
public interface MapKI<K> {
  ...
  /**
   * A map entry (key-value pair) for <tt>MapKI</tt>. The <tt>MapKI.entrySet</tt> method returns a
   ...
   * <tt>MapKI.Entry</tt> objects are valid <i>only</i> for the duration of the iteration; more
   ...
   * works properly across different implementations of the <tt>MapKI</tt> interface.
   *
